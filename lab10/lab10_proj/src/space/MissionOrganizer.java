...
public class MissionOrganizer implements Iterable<Mission>
{
	...
	{
		if(!cheap.contains(mission) && !expensive.contains(mission))
		{
	...
	{
		ArrayList<Mission> all = new ArrayList<Mission>();
		all.addAll(cheap);
		all.addAll(expensive);
		return all.iterator();
	...
	private final static Mission[]		TEST_MISSIONS =
	{
        ...
        new Mission("Pluto", 3E9f),
        new Mission("Venus", 3E10f),
        new Mission("Sun", 3E11f),
        new Mission("Mercury", 3E12f),
	};
